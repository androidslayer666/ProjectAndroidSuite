...
class MilestoneRepository @Inject constructor(
    ...
    suspend fun populateMilestonesByProject(projectId: Int) {
        try {
            val milestones = milestoneEndPoint.getLateMilestonesByProjectId(projectId).listMilestoneDtos
    ...
    fun getMilestoneByProject(projectId: Int): Flow<List<MilestoneEntity>> {
        return milestoneDao.getMilestoneByProjectIdFlow(projectId)
    }
    ...
    suspend fun putMilestoneToProject(
        ...
        try {
            val response =
                milestoneEndPoint.putMilestoneToProject(projectId, milestone.toMilestonePost())
